...
-- Run this if you're having issues with the initial migration
...
-- Function to auto-update inventory status
...
AND table_name IN ('user_profiles', 'inventory_items', 'activity_logs');
